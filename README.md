...
Este proyecto implementa una red social con un sistema de recomendaciones basado en análisis de similitudes entre usuarios. El sistema permite gestionar usuarios, sus intereses, relaciones de amistad y proporciona recomendaciones personalizadas.
...
2. Algoritmo de Recomendación con Ponderación
    ...
    - Fase 3: Selecciona los 4 gustos mejor puntuados excluyendo los ya existentes
